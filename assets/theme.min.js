...
// Trigger cart button
$(".Sticky_cartBtnn .add-to-cart").click(function(){
...
$(document).ready(function(){
    $('.template--custom .Sticky_cutmtabs ul.Custom_tabsbar li').on('click',function(){
      $('.template--custom .Sticky_cutmtabs ul.Custom_tabsbar li.active_bar').removeClass('active_bar');
      //var a_val=$(this).find('a').text();
      //console.log(a_val);
      $(this).addClass('active_bar');
      if($(this).hasClass('active_bar')){
          $('.template--custom .Sticky_cutmtabs ul.Custom_tabsbar li.active').removeClass('active');
          $('.template--custom .Sticky_cutmtabs ul.Custom_tabsbar li').find('a.StickyAnchor_navigate').removeClass('StickyAnchor_navigate');
      }
    })
});
